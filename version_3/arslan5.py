...
async def exchnge2(reader, writer,us):
    try:
        current_bandwidth =  0
        tot_data=0
        tot_time = 0
...
async def handle_local_connection(reader, writer):
    ...
    try:
        ...
        await asyncio.wait({
            asyncio.create_task(exchnge2(reader, srv_writer,username)),
            asyncio.create_task(exchnge2(srv_reader, writer,username))
        })
